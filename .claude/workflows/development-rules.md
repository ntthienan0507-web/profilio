...
When completing new features/APIs, **MUST** update or create API guide:
- **Location**: `modules/{module}/API_GUIDE.md` (in code module folder)
- **Trigger**: New endpoint, updated endpoint, new module, breaking changes
- **Content**: Endpoint path, method, params, request/response examples, permissions
- See `./workflows/documentation-management.md` for full structure