...
**MANDATORY**: When implementing new features/APIs, update or create API guide in the corresponding code module:

| Trigger | Action |
|---------|--------|
| New API endpoint | Create/update `modules/{module}/API_GUIDE.md` |
| Updated endpoint | Update existing API guide with changes |
| New module | Create new API guide for the module |
| Breaking changes | Mark deprecated endpoints, document migration |

**API Guide Location**: `modules/{module}/API_GUIDE.md` (in code module folder)
- Example: `modules/sla/API_GUIDE.md`, `modules/tickets/API_GUIDE.md`
...
### GET /api/v4/{path}
Description, query params, response example.

### POST /api/v4/{path}
Description, request body, response example.

## Authentication
Required headers, permissions.

## Notes
Important considerations, thresholds, etc.
```
